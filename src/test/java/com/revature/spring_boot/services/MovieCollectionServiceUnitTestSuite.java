...
public class MovieCollectionServiceUnitTestSuite {
    ...
    public void test_updateMovieCollectionById(){
        ...
        MovieCollectionInsertDTO movieCollections = new MovieCollectionInsertDTO();
        //movieCollections.setCollId(50);
        MovieCollections movieCollections1 = new MovieCollections();

        //mockCollRepo.save(movieCollections);

        when(mockCollRepo.findById(anyInt())).thenReturn(Optional.of(movieCollections1));
